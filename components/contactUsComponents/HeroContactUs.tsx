...
import LocationImg from "@/public/contactUs/location.png";
import CallImg from "@/public/contactUs/call.png";
import MailBoxImg from "@/public/contactUs/mail-box.png";
import Co from "@/public/cover-color.png";
import cover from '@/public/cover.jpg'
const BoxesContact = [
  {
    img: MailBoxImg,
    name: "البريد الالكتروني",
    desc: "havealook@gmail.com",
    descLink: "mailto:havealook@gmail.com",
  },
  {
    img: CallImg,
    name: "رقم الهاتف",
    desc: "+90 539 389 14 50",
    descLink: "tel:+905393891450",
  },
  {
    img: LocationImg,
          ...
          {BoxesContact.map((item, index) => (
            ...
            >
              <Image
                src={item.img}
                alt={item.name}
                className="bg-white max-[320px]:w-5/6 rounded-full border-2 border-primary p-3"
                width={150}
                height={150}
              />
              <h1 className="text-xl text-center mt-3 max-sm:text-lg">
                {item.name}
              </h1>
              ...
              <a
                href={item.descLink}
                className="
             whitespace-pre-wrap max-[350px]:text-sm text-gray-400 text-center text-lg"
                dir="ltr"
              >
                {item.desc}
              </a>
