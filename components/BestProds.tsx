...
const BestProds = ({ image, title, desc, btnTitle,btnLink,right }: any) => {
  ...
  return (
    <>
      {right ? (
        <>
          <div className="flex items-center max-lg:flex-col px-12 max-sm:px-4 py-10 bg-white">
            ...
            <div
              className=" w-3/6 p-5 gap-y-7 flex flex-col max-lg:justify-center
           max-lg:items-center max-lg:text-center max-lg:w-full max-sm:px-2"
            >
              <h2 className="text-primary text-5xl max-sm:text-4xl font-bold ">
                {title}
              </h2>
